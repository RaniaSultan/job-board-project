...
<li class="navbar-item">
    <a class="nav-link" href="{{ route('applications.index', ['post_id' => $post_id, 'status' => 'waiting']) }}">Pending Applications</a>
</li>
<li class="navbar-item">
    <a class="nav-link" href="{{ route('applications.index', ['post_id' => $post_id, 'status' => 'accepted']) }}">Accepted Applications</a>
</li>
<li class="navbar-item">
    <a class="nav-link" href="{{ route('applications.index', ['post_id' => $post_id, 'status' => 'rejected']) }}">Rejected Applications</a>
</li>
<li class="navbar-item">
    <a class="nav-link" href="{{ route('applications.index', ['post_id' => $post_id, 'status' => 'cancelled']) }}">Cancelled Applications</a>
</li>
@endsection
