...
<div class="container mt-5">
    ...
    <div class="card mb-4 shadow-sm m-outa" style="max-width: 90%; margin-left: auto; margin-right: auto;">

        <div class="row g-0">
            <div class="col-md-4">
                <img src="{{ asset('storage/' . $post->logo) }}" class="img-fluid rounded-start" alt="Post Image"
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <p class="text-teal">Location: <small class="text-muted">{{ $post['location'] }}</small>
                        </p>
                        <p class="text-teal">Work Type: <small class="text-muted">{{ $post['workType'] }}</small>
                        </p>
                        <p class="text-teal">Category: <small class="text-muted">{{ $post['category'] }}</small>
                        </p>
